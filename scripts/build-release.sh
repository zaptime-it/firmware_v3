...
case "$variant" in
    lolin_s3_mini_213epd|lolin_s3_mini_29epd)
        flash_size=4MB
        partition_table="${repo_root}/partition.csv"
        ;;
    btclock_rev_b_213epd)
        flash_size=8MB
        partition_table="${repo_root}/partition_8mb.csv"
        ;;
    btclock_v8_213epd)
        flash_size=16MB
        partition_table="${repo_root}/partition_16mb.csv"
        ;;
    *)
...
"${repo_root}/scripts/build.sh" "$variant"
